// Traductions (extrait minimal, à étendre selon vos besoins)
const translations = {
  fr: {
    ...
    // Ajoutez toutes les clés nécessaires ici
  },
  en: {
  ...
  ru: {
    ...
    offer_badge: "Специальное предложениe к осени 2025",
...
class MultiLanguageManager {
  ...
  applyLanguage(lang) {
    if (!translations[lang]) {
      console.warn(`Pas de traductions pour la langue: ${lang}`);
      return;
    }
    // Met à jour tous les éléments ayant data-translate
    document.querySelectorAll('[data-translate]').forEach(el => {
      ...
      if (el.tagName === 'TITLE') {
        ...
        el.innerHTML = text; // Utiliser innerHTML au cas où il y a des balises <b>, etc.
      }
    });
